...
static const char qt_meta_stringdata_CheckUpdatesThread[] = {
    "CheckUpdatesThread\0\0reply\0"
...
const QMetaObjectExtraData CheckUpdatesThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CheckUpdatesThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CheckUpdatesThread,
      qt_meta_data_CheckUpdatesThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CheckUpdatesThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CheckUpdatesThread))
