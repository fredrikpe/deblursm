...
static const char qt_meta_stringdata_DeconvolutionTool[] = {
    "DeconvolutionTool\0\0,\0progressEvent(int,QString)\0"
};
...
const QMetaObjectExtraData DeconvolutionTool::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DeconvolutionTool::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DeconvolutionTool,
      qt_meta_data_DeconvolutionTool, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DeconvolutionTool::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeconvolutionTool))
